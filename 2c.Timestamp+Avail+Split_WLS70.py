...
# ============================================================================
# Writing the output file for Vhm
out = open('Vhm.txt', 'w')
...
# Writing the output file for dVh
out = open('dVhm.txt', 'w')
for i in range(len(Timestamp_correct)):
    out.write(str(Timestamp_correct[i]))
    out.write('\t')
...
# Writing the output file for VhMax
out = open('VhMax.txt', 'w')
for i in range(len(Timestamp_correct)):
    out.write(str(Timestamp_correct[i]))
    out.write('\t')
    for j in range(0, levels):
...
# Writing the output file for VhMin
out = open('VhMin.txt', 'w')
for i in range(len(Timestamp_correct)):
    out.write(str(Timestamp_correct[i]))
    out.write('\t')
    for j in range(0, levels):
...
# Writing the output file for Dir
out = open('Dir.txt', 'w')
for i in range(len(Timestamp_correct)):
    out.write(str(Timestamp_correct[i]))
    out.write('\t')
...
# Writing the output file for um
out = open('um.txt', 'w')
for i in range(len(Timestamp_correct)):
    out.write(str(Timestamp_correct[i]))
    out.write('\t')
...
# Writing the output file for du
out = open('du.txt', 'w')
for i in range(len(Timestamp_correct)):
    out.write(str(Timestamp_correct[i]))
    out.write('\t')
...
# Writing the output file for vm
out = open('vm.txt', 'w')
for i in range(len(Timestamp_correct)):
    out.write(str(Timestamp_correct[i]))
    out.write('\t')
...
# Writing the output file for dv
out = open('dv.txt', 'w')
for i in range(len(Timestamp_correct)):
    out.write(str(Timestamp_correct[i]))
    out.write('\t')
...
# Writing the output file for wm
out = open('wm.txt', 'w')
for i in range(len(Timestamp_correct)):
    out.write(str(Timestamp_correct[i]))
    out.write('\t')
...
# Writing the output file for dw
out = open('dw.txt', 'w')
for i in range(len(Timestamp_correct)):
    out.write(str(Timestamp_correct[i]))
    out.write('\t')
...
# Writing the output file for CNRm
out = open('CNRm.txt', 'w')
for i in range(len(Timestamp_correct)):
    out.write(str(Timestamp_correct[i]))
    out.write('\t')
...
# Writing the output file for dCNR
out = open('dCNR.txt', 'w')
for i in range(len(Timestamp_correct)):
    out.write(str(Timestamp_correct[i]))
    out.write('\t')
...
# Writing the output file for CNRmax
out = open('CNRmax.txt', 'w')
for i in range(len(Timestamp_correct)):
    out.write(str(Timestamp_correct[i]))
    out.write('\t')
    for j in range(0, levels):
...
# Writing the output file for CNRmin
out = open('CNRmin.txt', 'w')
for i in range(len(Timestamp_correct)):
    out.write(str(Timestamp_correct[i]))
    out.write('\t')
    for j in range(0, levels):
...
# Writing the output file for sigmaFreqm
out = open('sigmaFreqm.txt', 'w')
for i in range(len(Timestamp_correct)):
    out.write(str(Timestamp_correct[i]))
    out.write('\t')
    for j in range(0, levels):
...
# Writing the output file for dsigmaFreq
out = open('dsigmaFreq.txt', 'w')
for i in range(len(Timestamp_correct)):
    out.write(str(Timestamp_correct[i]))
    out.write('\t')
    for j in range(0, levels):
...
# Writing the output file for Avail
out = open('Avail.txt', 'w')
for i in range(len(Timestamp_correct)):
    out.write(str(Timestamp_correct[i]))
    out.write('\t')
    for j in range(0, levels):
